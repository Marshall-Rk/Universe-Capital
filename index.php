...
<html class="no-js" lang="zxx">
   ...
   <body>
            ...
            <div class="offcanvas__content">
               ...
               <div class="offcanvas__contact">
                  ...
                  <div class="offcanvas__contact-content d-flex">
                     ...
                     <div class="offcanvas__contact-content-content">
                        <a href="">founder@universecapital.com</span>  </a>
                     </div>
                  </div>
                  <div class="offcanvas__contact-content d-flex">
                     <div class="offcanvas__contact-content-icon">
      ...
      <main>
                              ...
                              <div class="col-lg-7">
                                 <div class="tp-hero-content p-relative">
                                    <div class="tp-hero-title-wrapper">
                                       ...
                                       <h2 class="tp-hero-title">Our Mission</h2>
                                       <p>We aim to become a leading Debt syndication firm with one stop solution for all the financing requirements.</p>
                                    </div>
                                    <div class="tp-hero-button-wrapper d-flex flex-wrap align-items-center">
                                       <div class="tp-hero-btn mr-30">
                                           <a class="tp-btn" href="Universe-Capital-Brouchure.pdf">Download Brochure</a>
                              ...
                              <div class="col-lg-7">
                                 <div class="tp-hero-content p-relative">
                                    <div class="tp-hero-title-wrapper">
                                       ...
                                       <h2 class="tp-hero-title">Vision</h2>
                                       <p>To be a leading Pan-India corporate solutions provider and a perfect partner of choice to our corporate customers for their business expansion and growth.</p>
                                    </div>
                                    <div class="tp-hero-button-wrapper d-flex flex-wrap align-items-center">
                                       <div class="tp-hero-btn mr-30">
                                          <a class="tp-btn" href="Universe-Capital-Brouchure.pdf">Download Brochure</a>
         ...
         <!-- about area start -->
         <section class="tp-about-area p-relative pt-130 pb-50" id="about">
                     ...
                     <div class="tp-about-wrapper">
                        ...
                        <div class="tp-about-wrapper-list">
                           <ul>
                              ...
                              <li><span><i class="fa-regular fa-circle"></i></span> Quality</li>
                              <li><span><i class="fa-regular fa-circle"></i></span> Integrity</li>
                              <li><span><i class="fa-regular fa-circle"></i></span> Rapid Approach</li>
                           </ul>
                        </div>
         ...
         <!-- process area start -->
         <section class="tp-process-arae pt-30 pb-40" data-bg-color="#F6F6F9"  id="who">
            <div class="container">
               <div class="row">
                     ...
                     <div class="tp-process-wrapper">
                        ...
                        <div class="tp-process-item d-flex align-items-center">
                           ...
                           <div class="tp-process-item-content">                              
                              <p>We have a cohesive team of professionals with expertise across a wide variety of sectors and services. </p>
                           </div>
                        </div>
                        ...
                        <div class="tp-process-item d-flex align-items-center">
                           ...
                           <div class="tp-process-item-content">
                              ...
                              <p>Universe Capital Fund Raising Team expertise is in quickly finding appropriate growth capital financing solutions to suit each client’s specific needs.  </p>
                           </div>
                        </div>
                        ...
                        <div class="tp-process-item d-flex align-items-center">
                           ...
                           <div class="tp-process-item-content">
                              ...
                              <p>We use a proven methodology and process to raise capital and negotiate financing terms that satisfy both our clients and financial institutions. </p>
                           </div>
                        </div>
                        <div class="tp-process-item d-flex align-items-center">
                           <div class="tp-process-item-icon">
                        ...
                        <div class="tp-process-item d-flex align-items-center">
                           ...
                           <div class="tp-process-item-content">
                              ...
                              <p>Our fund-raising services for NBFC’s, SME’s, Mid Corporates , Startups, Developer Financing, Renewable Energy Segment include capital raising of equity, debt and structured capital, BC partnership, Co-Lending, DA/PTC and debt restructurings.</p>
                           </div>
                        </div>
                     ...
                     <div class="tp-process-thumb-wrapper p-relative wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                        ...
                        <div class="tp-process-counter d-flex align-items-center">
                           ...
                           <div class="tp-process-content">
                              <h4 class="tp-process-counter-title"><span class="purecounter" data-purecounter-duration="3" data-purecounter-end="1250"></span>Cr+</h4>
                              <p>Debt Syndication</p>
                           </div>
                        </div>
                        <div class="tp-process-trusted text-center">
                           <p style="font-size:14px;">Financial Institution <br> <span>150+</span></p>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <!-- service area start -->
         <section class="tp-service-area pt-40 pb-20" data-bg-color="#F6F6F9" id="services">
            <div class="container">
               <div class="row">
                  <div class="col-lg-6 col-md-8">
                     <div class="tp-service-title-wrapper mb-40">
                        <span class="tp-section-title-pre">Our services</span>
                        <h3 class="tp-section-title">Our services covers the following:</h3>
                     </div>
                  </div>
...
<div class="swiper-slide">
                           <div class="tp-service-item-wrapper p-relative">
                              ...
                              <div class="tp-service-item-content">
                                 <h4 class="tp-service-item-title"><a href="#">ESG Advisory</a></h4>
                                 <p>Corporate ESG Reporting Advisory: Enhancing Sustainability</p>
                              </div>
                              <div class="tp-service-item-thumb">
                                 <a href="#"><img src="assets/img/service/img-4.jpg" alt=""></a>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                           <div class="tp-service-item-wrapper p-relative">
                              ...
                              <div class="tp-service-item-content">
                                 <h4 class="tp-service-item-title"><a href="#">Tailored Financing</a></h4>
                                 <p>Tailored Financing: Development and LAP Support</p>
                              </div>
                              <div class="tp-service-item-thumb">
                                 <a href="#"><img src="assets/img/service/img-6.jpg" alt=""></a>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                           <div class="tp-service-item-wrapper p-relative">
                              ...
                              <div class="tp-service-item-content">
                                 <h4 class="tp-service-item-title"><a href="#">Collaborative Solutions</a></h4>
                                 <p>Collaborative Lending Solutions: Co-Lending, BC Partnerships, DA & PTC</p>
                              </div>
                              <div class="tp-service-item-thumb">
               ...
               <div class="row">
                     ...
                     <div class="tp-service-widget">
                        <div class="tp-service-widget-item mb-40">
                           <div class="tp-service-widget-tab">
                              <h3 class="tp-service-widget-title">For NBFC’S </h3>
                              <ul>
                                 <li class="active"><a href="#">Term Loan </a></li>
                                 <li class="active"><a href="#">Working Capital Limits</a></li>
                                 <li class="active"><a href="#">NCD / Commercial Paper</a></li>
                                 <li class="active"><a href="#">ECB | Co-Lending | DA/PTC</a></li>
                                 <li class="active"><a href="#">Business Correspondent Model</a></li>
                              </ul>
                           </div>
                        </div>   
                     </div>
                  ...
                  <div class="col-lg-4">
                     <div class="tp-service-widget">
                        <div class="tp-service-widget-item mb-40">
                           <div class="tp-service-widget-tab">
                              <h3 class="tp-service-widget-title">For Green Financing (Renewable Energy Segment & Start up)</h3>
                              <ul>
                                 <li class="active"><a href="#">Solar Energy</a></li>
                                 <li class="active"><a href="#">EV Value Chain Finance</a></li>
                                 <li class="active"><a href="#">Clean Energy Startups</a></li>
                                 <li class="active"><a href="#">Renewable Innovation</a></li>
                              </ul>   
                           </div>
                        </div>   
                     </div>
                  ...
                  <div class="col-lg-4">
                     <div class="tp-service-widget">
                        <div class="tp-service-widget-item mb-40">
                           <div class="tp-service-widget-tab">
                              <h3 class="tp-service-widget-title">For SME & Real Estate</h3>
                              <ul>
                                 <li class="active"><a href="#">Developer Finance </a></li>
                                 <li class="active"><a href="#">Construction Linked Programme, Inventory Funding Scheme, Balance Transfer Option</a></li>
                                 <li class="active"><a href="#">Loan Against Property</a></li>
                                 <li class="active"><a href="#">Lease Rental Discounting</a></li>
         ...
         <!-- project area start -->
         <!-- <section class="tp-project-area pt-50 pb-95">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12">
         ...
         <!-- faq area start -->
         <section class="tp-faq-area p-relative pt-4 pb-40" data-background="assets/img/faq/bg-shape.png">
                        ...
                        <div class="tp-faq-counter-wrapper d-flex">
                           <div class="tp-faq-counter d-flex align-items-center mr-20 mb-30">
                              ...
                              <div class="tp-faq-counter-content">
                                 <h4 class="tp-faq-counter-title"><span class="purecounter" data-purecounter-duration="3" data-purecounter-end="5"></span>+</h4>
                                 <p>Experiences</p>
                              </div>
                           </div>
                           <div class="tp-faq-counter d-flex align-items-center mb-30">
                              ...
                              <div class="tp-faq-counter-content">
                                 <h4 class="tp-faq-counter-title"><span class="purecounter" data-purecounter-duration="2" data-purecounter-end="1250"></span>Cr+</h4>
                                 <p style="font-size: 16px;">Debt Syndication</p>
                              </div>
                           </div>
                        </div>
                     </div>
           ...
           <section class="tp-service-area pb-20" data-bg-color="#F6F6F9" >
            <div class="container">
               <div class="row">
                  <div class="col-lg-6 col-md-8">
                     <div class="tp-service-title-wrapper mt-5 mb-40">                    
                        <h3 class="tp-section-title">Our Customised Offering</h3>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-4">
                     <div class="tp-service-nav text-end">
                     ...
                     <div class="swiper-wrapper mb-30 mt-40">
                        <div class="swiper-slide">
                           <div class="tp-service-item-wrapper p-relative">
                              ...
                              <div class="tp-service-item-content">
                                 <h4 class="tp-service-item-title"><a href="#">Debt Advisory</a></h4>
                                 <p>Our debt advisory teams provide essential refinancing and debt capital markets advice to NBFC’s ,Mid-market and Renewable Energy companies</p>
                              </div>
                              <div class="tp-service-item-thumb">
                                 <a href="#"><img src="assets/img/service/img-7.jpg" alt=""></a>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                           <div class="tp-service-item-wrapper p-relative">
                              ...
                              <div class="tp-service-item-content">
                                 <h4 class="tp-service-item-title"><a href="#">Capital Markets</a></h4>
                                 <p>Our debt advisory services cover debt raising, refinancing and restructuring, private placement, acquisition financing, direct lending, and bond issuance advice to clients across India
                                 </p>
                              </div>
                              <div class="tp-service-item-thumb">
                                 <a href="#"><img src="assets/img/service/img-8.jpg" alt=""></a>
                              </div>
                           </div>
                        </div>
...
<div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                           <div class="tp-service-item-wrapper p-relative">
                              ...
                              <div class="tp-service-item-content">
                                 <h4 class="tp-service-item-title"><a href="#">Investor Negotiation</a></h4>
                                 <p>Managing the due diligence process and negotiating with potential investors</p>
                              </div>
                              <div class="tp-service-item-thumb">
                                 <a href="#"><img src="assets/img/service/img-10.jpg" alt=""></a>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="tp-service-widget">
                        <div class="tp-service-widget-item mb-40">
                           <div class="tp-service-widget-tab">
                              <h3 class="tp-service-widget-title">For NBFC’S </h3>
                              <ul>
                                 <li class="active"><a href="#">Business Finance  </a></li>
                                 <li class="active"><a href="#">SME Finance | MSME </a></li>
                                 <li class="active"><a href="#">Microfinance </a></li>
                                 <li class="active"><a href="#">Fintech</a></li>
                                 <li class="active"><a href="#">Housing Finance | Gold Loan</a></li>
                              </ul>
                           </div>
                        </div>   
                     </div>
         ...
         <section class="tp-service-details-area pt-30 pb-30" id="whyus">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12 col-md-8">
                     <div class="tp-service-title-wrapper mt-5 mb-40">  
                        <center>
                        <h3 style="font-size: 28px;">Why Universe Capital For Debt Syndication? </h3></center>                  
                     </div>
                  </div>
                  <div class="col-lg-12">
                     <div class="tp-service-details-wrapper">
                        
                        <h3 class="tp-service-details-title">Choosing Universe Capital</h3>
                        ...
                        <div class="tp-service-details-box d-flex mb-60">
                           <div class="tp-service-details-item d-flex mr-30">
                              ...
                              <div class="tp-service-details-content">
                                 ...
                                 <p>Expertise in Debt Capital Markets: UC is young and growing. During the last 5 years, we’ve made smart, strategic acquisitions and fund raising of NBFC’s of like minds and senior professionals who share our values and chose to join us and grow with us. Every market we operate in is as important as the next. Every employee is as valuable as the next. </p>
                              </div>
                           </div>
                           ...
                           <div class="tp-service-details-item d-flex mr-30">
                              ...
                              <div class="tp-service-details-content">
                                 <h3 class="tp-service-details-subtitle">Connect & Prosper</h3>
                                 <p>If you have a business and want advice, access to funds or better recognition in the market, then get in touch and we’ll show you how we can make a difference. 

                                    Contact UC today and benefit from our excellency in navigating the Indian financial market to meet your financing requirements faster.
                  ...
                  <div class="col-lg-12">
                   ...
                   <div class="tp-project-details-list">
                           ...
                           <li>
                              <span class="tp-project-details-list-title"><i class="fa-solid fa-check"></i> Working Capital Finance</span>
                           ...
                           <li>
                              ...
                              <p>Hybrid financing solutions combining debt and equity elements
</p>
                           </li>

                           <li>
                              <span class="tp-project-details-list-title"><i class="fa-solid fa-check"></i> Securitization Expertise</span>
                              <p>Assistance in DA/PTC transaction and DA of loans originated under co-lending model , Standardised approach to direct assignment meeting true sale criteria and in compliance with RBI guideline
         ...
         <section id="features" class="tp-faq-area p-relative pt-4 pb-40" data-background="assets/img/faq/bg-shape.png">
            <div class="tp-faq-bg"></div></section>


            <section class="tp-faq-breadcrumb-area pt-10 pb-10" >
               <div class="container">
                  <div class="row">
                     <h3 class="tp-service-details-title">Extraordinary Support to Client in Growth</h3>
                     <div class="col-lg-6">
                              ...
                              <div class="accordion-item">
                                 <h2 class="accordion-header" id="headingOne">
                                   <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                    Experienced professionals having 50+ years of experience in advising and serving clients in debt syndication and structured finance
                                   </button>
                                 </h2>
                                 <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#general_accordion">
                                   <div class="accordion-body">
                                     <p>UC has relationships with commercial banks, alternate asset managers, also as structuring capabilities that guide our clients to success in securing debt for his or her company. To satisfy all the income needs of the clients, we offer innovative solutions for both fund and non-fund based requirements creating tangible value for the clients. we provide assistance throughout the transaction process from initial strategy formulation through to implementation</p>
                                   </div>
                                 </div>
                               </div>
                        ...
                        <div class="tp-faq-breadcrumb-tab-content tp-accordion">
                           <div class="accordion" id="general_accordion-2">
                              ...
                              <div class="accordion-item">
                                 ...
                                 <div id="collapsefive" class="accordion-collapse collapse" aria-labelledby="headingfive" data-bs-parent="#general_accordion-2">
                                   <div class="accordion-body">
                               ...
                               <div class="accordion-item">
                                 ...
                                 <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#general_accordion">
                                   <div class="accordion-body">
                                     <p>The Process of Syndication is completed within the following stages:<br>
                                        1. Understanding the wants of clients and preparing a suitable financing structure<br>
                                        2. Appraisal and detailed due diligence<br>
                                        3. Preparation and Circulation of data Memorandum (IM)<br>
                                        4. Coordinating with lenders/investors to make sure timely sanction of facilities<br>
                                        5. Harmonizing the terms and conditions among all lenders/investors<br>
                                        6. Documentation
                                   </p>
                                   </div>
                                 </div>
         ...
         <section class="tp-contact-breadcrumb-area pt-10 pb-30" id="contact">
            <div class="container">
               <div class="tp-contact-breadcrumb-box">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    <div class="tp-contact-breadcrumb-btn">
                                       <button class="tp-btn" type="submit" id="btn1"><i class="flaticon-send"></i><span class="text">SEND NOW</span></button>
                 ...
                 jQuery('#btn1').html('<i class="fas fa-spinner fa-spin"></i> Wait...');
                    ...
                    jQuery.ajax({
                       ...
                       success:function(result){            
                          ...
                          jQuery('#btn1').html('<i class="fa fa-check" aria-hidden="true"></i> Done');
                        ...
                        <div class="tp-contact-breadcrumb-wrapper">
                           ...
                           <div class="tp-contact-breadcrumb-item mb-40 d-flex">
                              ...
                              <div class="tp-contact-breadcrumb-item-content">
                                 ...
                                 <a href="https://www.google.com/maps" target="_blank">Office No.1, Shree Siddhivinayak Commerical Complex, Sector-10, Airoli, Navi Mumbai - 400708</a>
                              </div>
                           </div>
               ...
               <div class="row">
                  <div class="col-lg-3 col-md-6">
                     <div class="tp-team-item p-relative wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        ...
                        <div class="tp-team-info text-center">
                           <h4 class="tp-team-info-title"><a href="team-details">Albert Flores</a></h4>
                           <p>Designer</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-6">
                     <div class="tp-team-item p-relative wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                        ...
                        <div class="tp-team-info text-center">
                           <h4 class="tp-team-info-title"><a href="team-details">Kathryn Murphy</a></h4>
                           <p>Designer</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-6">
                     <div class="tp-team-item p-relative wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
                        ...
                        <div class="tp-team-info text-center">
                           <h4 class="tp-team-info-title"><a href="team-details">Marvin McKinney</a></h4>
                           <p>Designer</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-6">
                     <div class="tp-team-item p-relative wow fadeInUp" data-wow-duration="1s" data-wow-delay=".9s">
                        ...
                        <div class="tp-team-info text-center">
                           <h4 class="tp-team-info-title"><a href="team-details">Leslie Alexander</a></h4>
                           <p>Designer</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <a class="icon linkedin" href="https://www.linkedin.com/company/universe-capital/"><i class="fab fa-linkedin"></i></a>
                     ...
                     <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="tp-footer-widget tp-footer-col-3 mb-50">
                           <h3 class="tp-footer-widget-title">Services Covers </h3>
                           <div class="tp-footer-widget-content">
                              <ul>
                                 <li><a href="#">For NBFC’S </a></li>
                                 <li><a href="#">For Green Financing (Renewable Energy Segment & Start up)</a></li>
                                 <li><a href="#">For SME</a></li>                               
                  ...
                  <div class="row">
                     <div class="col-md-12 col-lg-6">
                        <div class="tp-footer-copyright-inner">
                           <p>Unvierse Capital | All Rights Reserved | Created with honor by <a style="color:#87CEEB" target="_blank" href="https://www.nextgenpixel.co.in/">Nextgenpixel</a></p>
                        </div>
                     </div>
